...
const Navber = () => {
  ...
  <div className="flex flex-nowrap">
    <a className="btn btn-ghost nav_head_font  items-center normal-case text-xl text-black"><FaHome className='mx-2 text-[#F25A2C] relative bottom-[2px] text-[25px] '/>Saarte Investeering</a>
  </div>
  </div>
